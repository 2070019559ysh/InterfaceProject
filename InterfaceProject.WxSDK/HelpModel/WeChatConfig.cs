    ...
    public class WeChatConfig
    {
        ...
        private static List<WeChatConfig> weChatConfigList = new List<WeChatConfig>()
        {
            new WeChatConfig(){//远平给的测试号
                Id="itfc176ksamhtx4yx2fz",
                AppName="远平给的测试版——公众号",
                AppID="wx6d0f44f420e119c1",
                AppSecret="2ec731018c7cae6cb7602d76ff5f79c2",
                Url="http://interface.yshdevelop.club/wechat",
                Token="3AF0C6F39E514D6E2244B33E8B2A6C0B",
