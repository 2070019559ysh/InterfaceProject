...
namespace InterfaceProject.Tool
{
    ...
    public static class MimeMapping
    {
        ...
        /// <summary>
        /// 往内存集合中记录扩展对应的Mime-Type
        /// </summary>
        /// <param name="extension">文件扩展名，如：.txt</param>
        /// <param name="MimeType">对应的Mime-Type，如：text/plain</param>
        ...
        /// 获取指定文件的Mime-Type
        /// </summary>
        /// <param name="fileName">带扩展名的文件名，可以带路径</param>
        /// <returns>文件对应的Mime-Type</returns>
        ...
        static MimeMapping()
        {
            ...
            MimeMapping.AddMimeMapping(".amr", "voice/amr");
            ...
            MimeMapping.AddMimeMapping(".flv", "video/flv");
            ...
            MimeMapping.AddMimeMapping(".mp4", "video/mp4");
            MimeMapping.AddMimeMapping(".mkv", "video/mkv");
            ...
            MimeMapping.AddMimeMapping(".wma", "voice/wma");
