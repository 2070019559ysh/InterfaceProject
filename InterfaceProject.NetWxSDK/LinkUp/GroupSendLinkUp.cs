...
namespace InterfaceProject.NetWxSDK.LinkUp
{
    ...
    public class GroupSendLinkUp: IGroupSendLinkUp
    {
        ...
        public WeChatResult<UploadNewsResult> UpdateNews(ArticleNews articleNews)
        {
            ...
            if (weChatResult.errcode != WeChatErrorCode.SUCCESS)
            {
                SystemLogHelper.Warn(MethodBase.GetCurrentMethod(), $"上传图文消息素材UpdateNews，微信服务报错：{weChatResult}");
            }
            return weChatResult;
        }
        ...
        public WeChatResult<GroupSendResult> SendAll(TagSendParam tagSendParam)
        {
            ...
            if (weChatResult.errcode != WeChatErrorCode.SUCCESS)
            {
                SystemLogHelper.Warn(MethodBase.GetCurrentMethod(), $"根据标签进行群发SendAll，微信服务报错：{weChatResult}");
            }
            return weChatResult;
        }
        ...
        public WeChatResult<GroupSendResult> PreviewSendAll(PreviewAccount previewAccount ,OpenIdSendParam openIdSendParam)
        {
            ...
            if (weChatResult.errcode != WeChatErrorCode.SUCCESS)
            {
                SystemLogHelper.Warn(MethodBase.GetCurrentMethod(), $"群发消息预览PreviewSendAll，微信服务报错：{weChatResult}");
            }
            return weChatResult;
        }
        ...
        public WeChatResult<GroupSendStatusResult> GetSendStatus(int msgId)
        {
            ...
            if (weChatResult.errcode != WeChatErrorCode.SUCCESS)
            {
                SystemLogHelper.Warn(MethodBase.GetCurrentMethod(), $"查询群发消息发送状态GetSendStatus，微信服务报错：{weChatResult}");
            }
            return weChatResult;
        }
        ...
        public WeChatResult SetSendSpeed(int speed)
        {
            ...
            if (weChatResult.errcode != WeChatErrorCode.SUCCESS)
            {
                SystemLogHelper.Warn(MethodBase.GetCurrentMethod(), $"设置群发速度SetSendSpeed，微信服务报错：{weChatResult}");
            }
            return weChatResult;
        }
        ...
        public WeChatResult<GroupSendSpeed> GetSendSpeed()
        {
            ...
            if (weChatResult.errcode != WeChatErrorCode.SUCCESS)
            {
                SystemLogHelper.Warn(MethodBase.GetCurrentMethod(), $"获取群发速度GetSendSpeed，微信服务报错：{weChatResult}");
            }
            return weChatResult;
        }
    }
