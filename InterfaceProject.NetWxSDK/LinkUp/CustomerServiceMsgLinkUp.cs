...
namespace InterfaceProject.NetWxSDK.LinkUp
{
    ...
    public class CustomerServiceMsgLinkUp: ICustomerServiceMsgLinkUp
    {
        ...
        public WeChatResult AddAccount(string account,string nickName,string password)
        {
            ...
            {
                SystemLogHelper.Warn(MethodBase.GetCurrentMethod(), $"新增客服帐号AddAccount，微信服务报错：{weChatResult}");
            }
            return weChatResult;
        }
        ...
        public WeChatResult UpdateAccount(string account, string nickName, string password)
        {
            ...
            if (weChatResult.errcode != WeChatErrorCode.SUCCESS)
            {
                SystemLogHelper.Warn(MethodBase.GetCurrentMethod(), $"修改客服帐号UpdateAccount，微信服务报错：{weChatResult}");
            }
            return weChatResult;
        }
        ...
        public WeChatResult DeleteAccount(string account, string nickName, string password)
        {
            ...
            if (weChatResult.errcode != WeChatErrorCode.SUCCESS)
            {
                SystemLogHelper.Warn(MethodBase.GetCurrentMethod(), $"删除客服帐号DeleteAccount，微信服务报错：{weChatResult}");
            }
            return weChatResult;
        }
        ...
        public WeChatResult UpdateHeadImg(string account, string filePathName)
        {
            ...
            using (Stream fileStream = new FileStream(filePathName, FileMode.Open))
            {
                ...
                if (weChatResult.errcode != WeChatErrorCode.SUCCESS)
                {
                    SystemLogHelper.Warn(MethodBase.GetCurrentMethod(), $"设置客服帐号的头像UpdateHeadImg，微信服务报错：{weChatResult}");
                }
                return weChatResult;
            }
        }
        ...
        public WeChatResult<KFAccountInfo> SearchKFList()
        {
            ...
            if (weChatResult.errcode != WeChatErrorCode.SUCCESS)
            {
                SystemLogHelper.Warn(MethodBase.GetCurrentMethod(), $"获取所有客服账号SearchKFList，微信服务报错：{weChatResult}");
            }
            return weChatResult;
        }
